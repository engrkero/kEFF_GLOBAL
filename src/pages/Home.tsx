      ...
      <section className="relative overflow-hidden rounded-[2.5rem] bg-indigo-600 p-8 text-white shadow-2xl shadow-indigo-200">
        <div className="relative z-10 space-y-3">
          ...
          <div className="flex gap-2">
            <Link to="/sell" className="mt-4 bg-white text-indigo-600 px-5 py-2.5 rounded-2xl text-xs font-black shadow-sm active:scale-95 transition-all text-center">
              SELL NOW
            </Link>
            <Link to="/browse" className="mt-4 bg-indigo-500/50 backdrop-blur-md text-white px-5 py-2.5 rounded-2xl text-xs font-black shadow-sm active:scale-95 transition-all flex items-center gap-2 uppercase">
