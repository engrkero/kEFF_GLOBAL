      ...
      <div className="flex-1 overflow-y-auto px-4 space-y-3">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
            <div className="w-20 h-20 bg-slate-50 rounded-[3rem] flex items-center justify-center border border-slate-100">
              <MessageCircle className="w-10 h-10 text-indigo-200" />
            </div>
            <p className="text-xs font-black text-slate-400 uppercase tracking-widest">No active chats</p>
          </div>
        ) : (
          rooms.map((room: any) => (
            <Link 
